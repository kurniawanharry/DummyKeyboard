package id.co.orderfaz.feature.rate.client
...
object RateApiClient {
    ...
    private val okHttp : OkHttpClient.Builder = OkHttpClient.Builder().addInterceptor(Interceptor(){
        ...
        .addHeader("Authorization", Constants.BASE_TOKEN_PROD).addHeader("Content-type","application/json")
        chain.proceed(request.build())

    })

    private val builder : Retrofit.Builder = Retrofit.Builder().baseUrl(Constants.BASE_URL_RATE).addConverterFactory(
